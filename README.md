...
- [Starshift](https://github.com/jakeayy/starshift) - A powerful modloader for a game In Stars and Time;
...
- [Keep Android Open (keepandroidopen.org)](https://keepandroidopen.org/) - Google wants to bring Android private and once that happens, developers of apps would have to verify EVERY SINGLE app they want to publish (even outside of Google Play Store) to them with **ID verification** and other measures. They've been **lying multiple times** about this change and don't back from them.
